...
public class Sisu extends Application {
    ...
    private ObservableList<String> degree_info;
    ...
    private ArrayList<TreeItem<String>> courseTreeItems; // all course tree items
    private String selected_checkbox = null; // selected checkbox
    private ArrayList<CheckBox> studentChoices = new ArrayList<>(); // all created chebox items
    ...
    private Image icon = new Image("https://opportunityforum.info/wp-content/uploads/2022/05/folder_green.png");
        ...
        showProgress.setOnAction((e) -> {
            ...
            if (!Degree.getModuleLists().isEmpty()) {
                ...
                if (studentChosenOption != null) {  //there is only degree option selected
                    program = new TreeItem<>(studentChosenOption.getModuleName());
                    ...
                    program = new TreeItem<>(Degree.getModuleName());
    ...
    private void loadFirstLevel(String degree_program) {
        ...
        Degree = new Modules(attributes.get(0), attributes.get(1), attributes.get(2), attributes.get(3), 0);
    ...
    private TreeItem<String> getLevelStructure(Modules module) {
        ...
        for (Courses course : module.getCoursesLists()) {
            ...
            if (course.getCompleted()) {
                sub_course.setGraphic(new ImageView(icon));
            }
